...
const ATTENDU = {
  equipe: 'PHILLY',
  taille: 24,
  echantillon: {nom: 'Sebastian Aho', salaire: 10625000, ct: 2, ov: 84},
  masseSousContrat: 53325000,
  nbSousContrat: 9,
  dateSecours: '8 juillet 2026',
  nbEchus: 15,
  nbBackups: 0,
  masseTotale: 103300000
};
...
(async () => {
  ...
  W.localStorage.removeItem('phi_resignatures_v1');
  W.localStorage.removeItem('phi_transac_v1');
